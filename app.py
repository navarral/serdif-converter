...
titleAndDataLink = html.Div([
    ...
    dbc.NavLink('Supported Data', href='https://github.com/navarral/serdif-api#data-provenance',
                target='_blank',
        ...
        dbc.CardBody([
            dbc.Row([
                ...
                dcc.Markdown('''              
                    ...
                    The linkage is the result of a semantic query that integrates environmental data **within the region of the event** 
        ...
        dbc.CardBody(
            [
                ...
                html.Div([
                    dcc.Markdown(
                        '''    
                        The integration of the environmental data sets requires to set the time unit resolution and
